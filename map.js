class Map {
    constructor(leafletjs, mapid, geojsonData) {
        ...
        this.markerPosition = [40.505,-100.09];
        this.markerOptions = {
    ...
    loadMap(event) {
        ...
        this.marker = this.leafletjs.marker(this.markerPosition, this.markerOptions).addTo(this.map);
        this.marker.bindPopup("Here is the content popped up.");
